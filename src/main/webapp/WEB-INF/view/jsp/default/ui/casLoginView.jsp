...
<div class="box" id="login">
  <form:form method="post" id="fm1" commandName="${commandName}" htmlEscape="true">
    ...
    <section class="row">
      <a href="${flowExecutionUrl}&_eventId=forgotPassword"><spring:message code="screen.welcome.link.forgotPassword" /></a>
    </section>
    ...
    <section class="row btn-row">
      ...
      <a href="${flowExecutionUrl}&_eventId=changePassword"><spring:message code="screen.welcome.link.changePassword" /></a>
    </section>
  </form:form>
</div>
